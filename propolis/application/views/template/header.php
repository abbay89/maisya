...
<html lang="en">
  <head>
	...
	<!-- Ion.RangeSlider -->
    <link href="<?php echo base_url()?>assets_front/vendors/normalize-css/normalize.css" rel="stylesheet">
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.html" class="site_title"><span>PGAS - Client Area</span></a>
            </div>
            ...
            <div class="profile clearfix">
              <div class="profile_pic">
				<img src="<?php echo base_url()?>assets_front/images/pgas-logo.png" class="img-circle profile_img"  width="100%"/>
              </div>
              <div class="profile_info">
                <span>Welcome,</span>
                <h2><?php echo $datajson->name ?></h2>
                <p><?php echo $datajson->cid ?></p>
              </div>
            </div>
            <!-- /menu profile quick info -->
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
					<!--
                  <li><a><i class="fa fa-user"></i> User Setting <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="index.html">User Info</a></li>
                      <li><a href="index2.html">Customer Product</a></li>
                    </ul>
                  </li>         
-->
					<li <?php echo $curent ?>><a href="<?php echo base_url()?>customer"><i class="fa fa-user"></i> Dashboard</a></li>
					<li><a href="<?php echo base_url()?>customer/detail_user"><i class="fa fa-user"></i> Profile</a></li>
					<li><a href="<?php echo base_url();?>customer/user_bandwidth"><i class="fa fa-user"></i> Service</a></li>				
					<li><a><i class="fa fa-user"></i> Support</a></li>
					<li><a href="<?php echo base_url()?>customer/billing"><i class="fa fa-user"></i>Billing</a></li>
					<li><a><i class="fa fa-user"></i> PGAS Product</a></li>
                </ul>
              </div>
            </div>
            <!-- /sidebar menu -->
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="images/img.jpg" alt=""><?php echo $datajson->name ?>
