...
//        $this->db->update('customer', $data);
    ...
    public function auth_customer($username, $password) {
        return $this->db->query("select cust_id, cust_name,cust_username from customer where (cust_username = ? or cust_phone = ?) and cust_password = ?", array($username, $username, $password))->row();
    }
