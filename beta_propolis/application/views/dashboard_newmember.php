									...
									<table id="demo-foo-addrow" class="table m-t-30 table-hover no-wrap contact-list" data-page-size="10">
										...
										<tbody>
											<?php
												...
												//print_r($lstProd);	
												$dtl_prod = file_get_contents("http://maisya.id:6070/api/ItemCodes?oid=".$lstProd->ItemCode_oid);
												$parse_data = json_decode($dtl_prod);
											?>
											<tr>
												<td><?php echo $parse_data->KodeItem ?></td>
												<td>
													<a href="javascript:void(0)"><img src="http://maisya.id:6070/api/itemCode_image?kodeitem=<?php echo $parse_data->KodeItem ?>&width=200&height=200" alt="user" class="img-circle" /> <?php echo $parse_data->Deskripsi ?></a>
												</td>
