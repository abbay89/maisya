						...
						<div class="col-lg-7 col-xlg-7 col-md-7">
							<table id="demo-foo-addrow" class="table m-t-30 table-hover no-wrap contact-list" data-page-size="10">
								<thead>
									...
									<tr>
										<th>Alamat Kirim</th>
										<th><select name="address" class="address col-lg-12 col-xlg-12 col-md-12"></select>
										<input type="hidden" name="sponsor_id" value="<?php echo $data_cust->Sponsor_id?>">
										<input type="hidden" name="cust_id" value="<?php echo $data_cust->id?>">
										</th>
									</tr>
								</tbody>
							</table>
										...
										<table id="demo-foo-addrow" class="table m-t-30 table-hover no-wrap contact-list" data-page-size="10">
											...
											<tbody>
												...
												<tr>
													...
													<td align="right">
														<a href="
															<?php echo site_url()?>/checkout/min_checkout/<?php echo $cart['rowid'] ?>/<?php echo ($cart['qty'] - 1) ?>"><i class="fa fa-minus"></i> </a><?php echo number_format($cart['qty'])?>
															<a href="
															<?php echo site_url()?>/checkout/min_checkout/<?php echo $cart['rowid'] ?>/<?php echo ($cart['qty'] + 1) ?>">
													...
													<td align="center"><a href="<?php echo  site_url()?>/checkout/del_checkout/<?php echo $cart['rowid'] ?>">
						...
						<div class="col-lg-5 col-xlg-5 col-md-5">
							<table id="demo-foo-addrow" class="table m-t-30 table-hover no-wrap contact-list" data-page-size="10">
								<thead>
									...
									<tr>
										<th colspan="2"><input type="submit" class="btn btn-warning col-lg-12 col-xlg-12 col-md-12 btn_checkout" value="Checkout" disabled=disabled/></th>
									</tr>
								</tbody>
							</table>
									<!--
