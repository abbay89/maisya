...
<head>
    ...
    <link href="<?php echo base_url()?>/css/colors/purple.css" id="theme" rel="stylesheet">
...
<body>
  ...
  <div class="login-box card">
    <div class="card-body">
      ...
      <form class="form-horizontal" id="recoverform" action="<?php echo site_url()?>/login/forgot" method="post">
        <div class="form-group ">
          <div class="col-xs-12">
        ...
        <div class="form-group ">
          <div class="col-xs-12">
            <input class="form-control" type="text" name="emailforgot" required="" placeholder="Email">
          </div>
        </div>
        <div class="form-group text-center m-t-20">
          <div class="col-xs-12">
