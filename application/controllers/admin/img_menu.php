...
class Img_menu extends CI_Controller {
    ...
    public function index() {
        try {
            ...
            $crud->set_table('img_menu');
            $crud->set_subject('Image Menu');
            $crud->display_as('img_loc', 'Location');
            $crud->display_as('img_url', 'Image Thumb');
            $crud->columns('img_loc', 'img_url');
            $crud->set_field_upload('img_url', 'assets/uploads/img_menu/');
