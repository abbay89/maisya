...
class Product extends CI_Controller {
	...
	public function category($cate,$type,$title='',$page=1,$unitprice='') {
		...
		$data['title_page']			= 	$tag ." Collection Maisya Jewellery Online Shop";
		$data['description_page']	=   $tag ." Collection Maisya Jewellery Online Shop";
		$data['keyword_page']		=   $tag.",maisya,jewellery,maisya jewellery,indonesia,rudy";
	...
	public function ajax_category($cate,$type,$page=1,$param='',$sortby='ProductID') {
		...
		if($unitprice == '')
		{
			$datajson	= json_decode($this->getDataFromServer('/api/products/24/'.$page.'/'.$sortby.'?tag='.$cate.'&subtag='.$type.'&metalType='.$metal.'&gender='.$gender.'&shape='.$shape.'&stoneType='.$stoneshape));
		}
		else
		{
			//print_r($unitprice);
			...
			//exit;
			$datajson	= json_decode($this->getDataFromServer('/api/products/24/'.$page.'/'.$sortby.'?tag='.$tag.'&subtag='.$subtag.'&minPrice='.$fminprice.'&maxPrice='.$fmaxPrice.'&metalType='.$metal.'&gender='.$gender.'&shape='.$shape.'&stoneType='.$stoneshape));
		}
	...
	public function detail($category,$id) {
		...
		$data['keyword_page']		=   $data['detail_product']->ProductName.",maisya,jewellery,maisya jewellery,indonesia,rudy";
