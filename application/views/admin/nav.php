                                ...
                                <ul>
                                    ...
                                    <li class="<?php echo $nav == 'reff' ? 'active' : '' ?>">
                                        ...
                                        <ul class="<?php echo $nav == 'reff' ? '' : 'closed' ?>">
											<li><a href="<?php echo base_url() ?>admin/reff/metatag">Meta Tag</a></li>
											<li><a href="<?php echo base_url() ?>admin/reff/img_setting">Image Setting</a></li>
											...
											<li><a href="<?php echo base_url() ?>admin/reff/paymentguide">Payment Guide</a></li>
											...
											<li><a href="<?php echo base_url() ?>admin/reff/maks_book">Maksimal Book</a></li>
                                        </ul>
                                    </li>
									...
									<li class="<?php echo $nav == 'our_collection' ? 'active' : '' ?>">
                                        <a href="<?php echo base_url() ?>admin/wedding_rings">
                                            <!-- Icon Container -->
                                            <span class="da-nav-icon">
                                                <img src="<?php echo base_url() ?>assets/grocery_crud/images/icons/black/32/trolly.png" alt="Location" />
                                            </span>
                                    ...
                                    <li class="<?php echo $nav == 'news' ? 'active' : '' ?>">
                                        <a href="<?php echo base_url() ?>admin/news">
                                            <!-- Icon Container -->
                                            <span class="da-nav-icon">
                                                <img src="<?php echo base_url() ?>assets/grocery_crud/images/icons/black/32/clipboard_1.png" alt="Events" />
                                            </span>
                                            News
                                        </a>
                                    </li>
