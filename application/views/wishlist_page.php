								...
								<div class="col-xs-12 col-md-2 col-sm-2 lst-ctl">
									...
									<div class="thumbnail thumb-wh">
										...
										<a class="liprod" href="<?php echo base_url()."detailproduct/".$listProduct->productid; ?>/1">
											...
											<img src='https://www.maisya.id:5060/api/ProductImages?kodeitem=<?php echo $listProduct->productid?>&width=200&height=200' alt="resized image" class="img-thumbnail image" />
											<?php
											...
											?>
												<div class="overlay">
													<img src="https://www.maisya.id:5060/api/ProductImages2?kodeitem=<?php echo $listProduct->productid?>&width=210&height=200" class="img-thumbnail image">
												</div>
											<?php
												}
											?>
											<div class="caption">
												...
												<div class="col-xs-12 col-md-12 col-sm-12">
													<div class="col-xs-6 col-md-6 col-sm-6">
														<a class="btn btn-google btn-lg btn-block" href="<?php echo base_url()?>wishlist/remove/<?php echo $listProduct->productid ?>">
															<i class="fas fa-trash-alt"></i>
														</a>
													</div>
													<div class="col-xs-6 col-md-6 col-sm-6">
														<a class="btn btn-google btn-lg btn-block" href="<?php echo base_url()."detailproduct/".$listProduct->productid; ?>/1">
															Buy
														</a>
													</div>
												</div>
