								...
								<div class="container ftr-menu">
									<ul class="row">	
										<li class="col-xs-12 col-md-2 col-sm-2 ">
											<span  > <a href="<?php echo base_url();?>about_us/contact"><i class="far fa-envelope-open"></i> &nbsp; Contact</a></span> 
											
										</li>
										<li class="col-xs-12 col-md-3 col-sm-3 ">
											<span  > <a href="whatsapp://send?text=Assalammualaikum Maisya..&phone=+6281514331660"><i class="far fa-user"></i> &nbsp; Chat Available</span></a>
								...
								<div class="container">
									<ul class="row">	
										<li class="col-xs-12 col-md-3 col-sm-3 ">
											...
											<ul>
												<li class="no-child">
													<a href="<?php echo base_url()?>staticpage/page/aboutus">About Us</a>
												</li>
												<li class="no-child">
													<a href="<?php echo  base_url()?>staticpage/page/contact">Contact Us</a> 
												</li>
												<li class="no-child">
													<a href="<?php echo  base_url()?>staticpage/page/shop">Shop</a>
												</li>
												<li class="no-child">
													<a href="<?php echo  base_url()?>staticpage/page/waranty">Warranty And Maintenance</a>
												</li>
											</ul>
										</li>
										<li class="col-xs-12 col-md-3 col-sm-3 ">
											...
											<ul>
												<li class="no-child">
													<a href="<?php echo  base_url()?>staticpage/page/termpolicy">Terms And Policy</a>
												</li>
												<li class="no-child">
													<a href="<?php echo  base_url()?>staticpage/page/privpolicy">Privacy Policy</a> 
												</li>
												<li class="no-child">
													<a href="<?php echo  base_url()?>staticpage/page/buyback">Buy Back / Exchange Policy</a>
												</li>
												<li class="no-child">
													<a href="<?php echo  base_url()?>staticpage/page/faq">FAQ</a>
												</li>
											</ul>
										</li>
										...
										<li class="col-xs-12 col-md-3 col-sm-3 ">
											...
											<ul>
												<li class="no-child">
													<a href="<?php echo  base_url()?>staticpage/page/shop_payment">Shopping & Payment</a>
												</li>
												<li class="no-child">
													<a href="<?php echo  base_url()?>staticpage/page/delivery_term">Delivery Terms</a> 
												</li>
												<li class="no-child">
													<a href="<?php echo base_url()?>staticpage/page/diamond_guide">Material Guide</a>
												</li>
												<li class="no-child">
													<a href="#">Blog</a>
												</li>
					...
					<ul>
						...
						<li class="no-child">
							...
							<div class="col-xs-10 col-md-10 col-sm-10">
								...
								<a href="https://www.instagram.com/maisyajewelleryid">
