				...
				<div class="row">
					<div class="col-xs-12 col-md-12 col-sm-12">
						...
						<div class=" col-xs-12 col-md-12 col-sm-12 hidden-lg">
							...
							<div class="col-xs-6 col-md-6 col-sm-6">
								<select name="filterOrderBy" class="filterOrderBy" id="sort_mob">
						...
						<div id="filterpage" class="col-xs-12 col-md-3 col-sm-3 category hidden-xs hidden-sm">
							...
							<div class="accordion odd">
							  <h3>KARAT</h3>
							  <div class="content">
								<input name="page" type="hidden" class="form-control" value="<?php echo $pagingdt ?>">
							...
							<div class=" col-xs-12 col-md-12 col-sm-12 top-catalog hidden-xs hidden-sm">
								<div class="">
									...
									<div class=" col-xs-3 col-md-3 col-sm-3 pull-right">
										<select name="filterOrderBy" class="filterOrderBy">
											<option value="ProductID">Newest</option>
											<option value="rating">Popularity</option>
								...
								<div class="col-xs-6 col-md-4 col-sm-4 lst-ctl">
									...
									<div class="thumbnail thumb-detail">
										...
										<div class="icon-wh" style="z-index:1;">
											...
											<span class="kd-item"><?php echo $listProduct->ProductID?></span>
										</div>
										<a class="liprod" href="<?php echo base_url()."detailproduct/".$category."/".str_replace(".","",str_replace(" ","_",$listProduct->ProductName)."__k__".$listProduct->ProductID); ?>">
