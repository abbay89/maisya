					   ...
					   <div class="card-body">
							<div class="d-flex flex-row">
								...
								<div class="m-l-10 align-self-center">
									...
									<h5 class="text-muted m-b-0">Total Saldo</h5></div>
							</div>
						</div> 
                    </div>
				</div>
					...
					<div class="card">
					   <div class="card-body">
							<div class="d-flex flex-row">
								...
								<div class="m-l-10 align-self-center">
									<h3 class="m-b-0 font-light">$3249</h3>
									<h5 class="text-muted m-b-0">Repeat Order</h5></div>
							</div>
						</div> 
                    </div>
				</div>
							...
							<div class="card-body">
								<div class="blog-image">
									<a href="<?php echo site_url()?>/customer/detail/<?php echo $lstProd->OID?>">
										<img class="img-responsive" alt="img" src="https://maisya.id:6070/api/itemCode_image?kodeitem=<?php echo $lstProd->KodeItem ?>&width=200&height=200">
									</a>
								</div>
