								...
								<div class="col-xs-12 col-md-4 col-sm-4 lst-ctl">
									...
									<div class="thumbnail">
										...
										<a href="<?php echo base_url()."detailproduct/".$listProduct->ProductID; ?>">
											...
											<!--<img src='<?php echo base_url()?>resizer.php?url=https://cl.maisya.co.id:5060/api/ProductImages?kodeitem=<?php echo $listProduct->ProductID?>' />-->
											<img src='<?php echo base_url()?>timthumb.php?src=https://cl.maisya.co.id:5060/api/ProductImages?kodeitem=<?php echo $listProduct->ProductID?>&w=100&h=80' alt="resized image" />
