...
class Location extends CI_Controller {
    ...
    public function index() {
        try {
            ...
            $crud->set_relation_n_n('feature_store', 'fitur_fit_location', 'fitur_location', 'location_id', 'fitur_id', 'fitur_name_en');
            ...
            $crud->display_as('store_id', 'Store Id');
            $crud->display_as('location_name_en', 'Store Name');
            $crud->display_as('location_name_idn', 'Store Name (Bahasa)');
            $crud->display_as('location_address_en', 'Address');
            ...
            $crud->display_as('weekday_open', 'Weekday Open');
            $crud->display_as('weekday_close', 'Weekday Close');
            $crud->display_as('weekend_open', 'Weekend open');
            $crud->display_as('weekend_close', 'Weekend Close');
            $crud->unset_add_fields('location_lat','location_long');
            $crud->set_subject('Location');
            $crud->columns('store_id','location_name_en', 'location_address_en', 'location_open_hour', 'location_lat', 'location_long','weekday_open','weekday_close','weekend_open','weekend_close');
